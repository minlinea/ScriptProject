...
def exception_handling(name, x, y):
    ...
    if name == '천등산휴게소(제천)':
        return '천등산', 127.58951558639039, 36.97034195422877, '제천', True
    if name == '천등산휴게소(평택)':
        return '천등산', 127.58951558639039, 36.97034195422877, '평택', True
    if name == '금왕휴게소(평택)':
        return '금왕', 127.93969902749748, 36.97034195422877, '평택', True
    if name == '금왕휴게소(제천)':
